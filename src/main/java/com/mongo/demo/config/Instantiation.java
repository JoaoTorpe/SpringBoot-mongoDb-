...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null,sdf.parse("21/03/2018"),"Partiu viajem","Vou viajar, abrços!",maria);
		Post post2 = new Post(null,sdf.parse("22/04/2019"), "Bom dia ", "Acordei feliz", maria);
